const config = {
  siteTitle: 'Bryan\'s Blog', // Site title.
  siteTitleShort: 'Bryan\'s Blog', // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
  siteTitleAlt: 'Bryan\'s Blog', // Alternative site title for SEO.
